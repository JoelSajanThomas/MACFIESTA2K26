...
export function RegistrationCTA() {
  ...
  return (
    <section className="relative bg-transparent section-padding overflow-visible border-t border-white/10 min-h-[480px] flex items-center justify-center">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10 space-y-8 px-4">
        ...
        <Reveal y={60} duration={0.7} margin="-100px">
          <div className="glass-aurora border border-white/15 p-6 sm:p-12 pb-8 sm:pb-12 rounded-3xl shadow-[0_0_60px_rgba(0,0,0,0.9)] space-y-8 max-w-4xl mx-auto !overflow-visible">
            ...
            {/* CTAs */}
            <div
              className="flex flex-col sm:flex-row justify-center items-stretch sm:items-center gap-3 sm:gap-4 pt-2 pb-1 w-full max-w-xl mx-auto"
            >
              <motion.div
              ...
              >
                {userLoggedIn ? (
                  <Link
                    ...
                    className="btn-urgency w-full px-5 sm:px-8 py-3 sm:py-4 group font-space flex items-center justify-center gap-2 shadow-[0_0_25px_rgba(0,212,255,0.4)] hover:shadow-[0_0_40px_rgba(0,212,255,0.7)] transition-shadow duration-300 !bg-arc-cyan !text-black !tracking-[0.08em]"
                  >
                    <RiDashboardLine className="text-base shrink-0" />
                    <span className="relative z-10 font-black tracking-[0.08em] sm:tracking-[0.12em] uppercase text-xs sm:text-sm whitespace-nowrap">
                  ...
                  <Link
                    href="/signup"
                    className="btn-urgency w-full px-5 sm:px-8 py-3 sm:py-4 group font-space flex items-center justify-center gap-2 shadow-[0_0_25px_rgba(237,29,36,0.5)] hover:shadow-[0_0_40px_rgba(237,29,36,0.8)] transition-shadow duration-300 !tracking-[0.08em]"
                  >
                    <span className="relative z-10 font-bold tracking-[0.08em] sm:tracking-[0.12em] uppercase text-xs sm:text-sm whitespace-nowrap">
                      Register Pass
                    </span>
                    <RiPlayLine className="group-hover:translate-x-1 transition-transform text-sm sm:text-lg relative z-10 shrink-0" />
                  </Link>
                )}
              </motion.div>
              ...
              <motion.div
                ...
                className="flex-1"
              >
                <Link href="/events" className="btn-outline w-full px-5 sm:px-8 py-3 sm:py-4 border-arc-cyan text-white hover:bg-arc-cyan/20 font-space flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(0,212,255,0.25)] hover:shadow-[0_0_35px_rgba(0,212,255,0.6)] transition-shadow duration-300 !tracking-[0.08em]">
                  <RiShieldFlashLine className="text-sm sm:text-base shrink-0" />
                  <span className="font-bold tracking-[0.08em] sm:tracking-[0.12em] uppercase text-xs sm:text-sm whitespace-nowrap">Explore Events</span>
                </Link>
              </motion.div>
            </div>
          </div>
