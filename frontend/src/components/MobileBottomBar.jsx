  ...
  return (
    <div className="fixed bottom-3 left-0 right-0 z-[90] xl:hidden pointer-events-none pb-[env(safe-area-inset-bottom)] px-3 sm:px-4">
      <nav
        ...
        className="max-w-[370px] sm:max-w-md mx-auto pointer-events-auto relative bg-[#05050A]/90 backdrop-blur-md border border-white/10 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_20px_rgba(0,212,255,0.08)] flex items-center justify-between px-2 py-1 font-excon"
      >
